...
@udf('boolean')
def is_sword_purchase_event(event_as_json):
    """udf for filtering sword purchasing events
    """
...
@udf('boolean')
def is_join_guild_event(event_as_json):
    """udf for filtering guild join events
    """
    event = json.loads(event_as_json)
...
def main():
    ...
    sword_purchases = raw_events \
        .filter(is_sword_purchase_event(raw_events.value.cast('string'))) \
